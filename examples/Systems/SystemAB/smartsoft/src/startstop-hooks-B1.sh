#!/bin/bash
#
# Start-Stop-Hooks for component B1
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentB.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentB.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentB.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentB.sh post-stop
