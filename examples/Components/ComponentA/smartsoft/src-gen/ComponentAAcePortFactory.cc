...
Smart::IPushClientPattern<CommBasicObjects::CommBaseState> * ComponentAAcePortFactory::createA_In()
{
	return new SmartACE::PushClient<CommBasicObjects::CommBaseState>(componentImpl);
}


Smart::IPushServerPattern<CommBasicObjects::CommBaseState> * ComponentAAcePortFactory::createA_Out(const std::string &serviceName)
{
