...
public:
	...
	virtual Smart::IPushClientPattern<CommBasicObjects::CommBaseState> * createA_In() = 0;
	
	virtual Smart::IPushServerPattern<CommBasicObjects::CommBaseState> * createA_Out(const std::string &serviceName) = 0;
