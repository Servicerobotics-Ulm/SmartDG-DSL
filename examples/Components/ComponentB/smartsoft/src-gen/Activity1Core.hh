...
private:
	...
	Smart::StatusCode b_InStatus;
	CommBasicObjects::CommBaseState b_InObject;
...
protected:
	...
	// overload and implement this method in derived classes to immediately get all incoming updates from B_In (as soon as they arrive)
	virtual void on_B_In(const CommBasicObjects::CommBaseState &input) {
		// no-op
	}
	
	// this method can be safely used from the thread in derived classes
	inline Smart::StatusCode b_InGetUpdate(CommBasicObjects::CommBaseState &b_InObject) const
	{
		// copy local object buffer and return the last status code
		b_InObject = this->b_InObject;
		return b_InStatus;
	}
	
	// this method is meant to be used in derived classes
	Smart::StatusCode b_OutPut(CommBasicObjects::CommBaseState &b_OutDataObject);
