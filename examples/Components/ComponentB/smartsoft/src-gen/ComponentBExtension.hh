...
#ifndef COMPONENTB_EXTENSION_HH_
#define COMPONENTB_EXTENSION_HH_
...
public:
	ComponentBExtension(const std::string &name);
	virtual ~ComponentBExtension();
...
#endif /* COMPONENTB_EXTENSION_HH_ */
