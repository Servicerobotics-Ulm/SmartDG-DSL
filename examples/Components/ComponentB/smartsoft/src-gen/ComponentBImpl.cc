...
ComponentBImpl::ComponentBImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

ComponentBImpl::ComponentBImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
...
int ComponentBImpl::startComponentInfrastructure(void)
{
...
void ComponentBImpl::stopComponentInfrastructure(const std::chrono::steady_clock::duration &timeoutTime)
{
	this->signalSmartTasksToStop(timeoutTime);
}
void ComponentBImpl::cleanUpComponentResources()
{
