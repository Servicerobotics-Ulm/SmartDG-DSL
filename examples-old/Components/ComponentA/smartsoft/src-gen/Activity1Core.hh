...
private:
	...
	Smart::StatusCode a_InStatus;
	CommBasicObjects::CommBaseState a_InObject;
...
protected:
	...
	// overload and implement this method in derived classes to immediately get all incoming updates from A_In (as soon as they arrive)
	virtual void on_A_In(const CommBasicObjects::CommBaseState &input) {
		// no-op
	}
	
	// this method can be safely used from the thread in derived classes
	inline Smart::StatusCode a_InGetUpdate(CommBasicObjects::CommBaseState &a_InObject) const
	{
		// copy local object buffer and return the last status code
		a_InObject = this->a_InObject;
		return a_InStatus;
	}
	
	// this method is meant to be used in derived classes
	Smart::StatusCode a_OutPut(CommBasicObjects::CommBaseState &a_OutDataObject);
