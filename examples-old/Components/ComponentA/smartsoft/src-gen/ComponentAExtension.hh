...
#ifndef COMPONENTA_EXTENSION_HH_
#define COMPONENTA_EXTENSION_HH_
...
public:
	ComponentAExtension(const std::string &name);
	virtual ~ComponentAExtension();
...
#endif /* COMPONENTA_EXTENSION_HH_ */
